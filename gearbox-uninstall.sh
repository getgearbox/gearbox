...
# This script uninstalls the gearbox rpms. The PKG_VERSION and PKG_RELEASE environment
...
for rpm_suffix in ${LIST_RPM[@]}; do
    sudo yum erase -y gearbox-$rpm_suffix-$PKG_VERSION-$PKG_RELEASE.el6.x86_64
done
sudo yum erase -y mod_gearbox-$PKG_VERSION-$PKG_RELEASE.el6.x86_64
